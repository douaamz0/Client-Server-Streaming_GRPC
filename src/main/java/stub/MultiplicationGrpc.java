...
public final class MultiplicationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.SalutationOuterClass.MultiplicationRequest,
      stub.SalutationOuterClass.MultiplicationResponse> getGetMultiplicationTableMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = stub.SalutationOuterClass.MultiplicationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<stub.SalutationOuterClass.MultiplicationRequest,
      stub.SalutationOuterClass.MultiplicationResponse> getGetMultiplicationTableMethod() {
    io.grpc.MethodDescriptor<stub.SalutationOuterClass.MultiplicationRequest, stub.SalutationOuterClass.MultiplicationResponse> getGetMultiplicationTableMethod;
      ...
      synchronized (MultiplicationGrpc.class) {
        if ((getGetMultiplicationTableMethod = MultiplicationGrpc.getGetMultiplicationTableMethod) == null) {
          MultiplicationGrpc.getGetMultiplicationTableMethod = getGetMultiplicationTableMethod = 
              io.grpc.MethodDescriptor.<stub.SalutationOuterClass.MultiplicationRequest, stub.SalutationOuterClass.MultiplicationResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.SalutationOuterClass.MultiplicationResponse.getDefaultInstance()))
  ...
  public static abstract class MultiplicationImplBase implements io.grpc.BindableService {
    ...
    public void getMultiplicationTable(stub.SalutationOuterClass.MultiplicationRequest request,
        io.grpc.stub.StreamObserver<stub.SalutationOuterClass.MultiplicationResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                ...
                stub.SalutationOuterClass.MultiplicationResponse>(
  ...
  public static final class MultiplicationBlockingStub extends io.grpc.stub.AbstractStub<MultiplicationBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<stub.SalutationOuterClass.MultiplicationResponse> getMultiplicationTable(
